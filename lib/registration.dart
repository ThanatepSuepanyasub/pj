        ...
        child: Center(
          child: Column(
            children: [
              ...
              SizedBox(height: 20),
              _inputField(context, "Password", passwordController,
                  isPassword: true),
              SizedBox(height: 50),
  ...
  Widget _icon() {
    return Container(
      decoration: BoxDecoration(
        border:
            Border.all(color: const Color.fromARGB(255, 14, 13, 13), width: 2),
        shape: BoxShape.circle,
      ),
      child: Icon(Icons.person_add,
          color: const Color.fromARGB(255, 10, 10, 10), size: 120),
    );
  }
